...
namespace Utilities
{
    ...
    public class ProgressManager
    {
        ...
        public static bool HasProgress() => FileManager.Exists(Properties.ProgressPath);
        ...
        public static PlayerProgress LoadProgress()
        {
            ...
            if (HasProgress())
            {
                using (FileStream fileStream = File.Open(Properties.ProgressPath, FileMode.Open))
                {
        ...
        public static void SaveProgress(PlayerProgress progress)
        {
            try
            {
                using (FileStream fileStream = File.Create(Properties.ProgressPath))
                {
                    BinaryFormatter binaryFormatter = new BinaryFormatter();
        ...
        public static void DeleteProgress()
        {
            try
            {
                if (HasProgress())
                {
                    FileManager.Delete(Properties.ProgressPath);
                }
            }
            catch (Exception ex)
            {
